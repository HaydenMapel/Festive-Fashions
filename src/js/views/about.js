...
export const About = () => {
	return (
		<div className="text-light container" id="aboutContainer">
			<h2 className="text-center p-4 pinkText">Who Are We?</h2>
			...
			<h2 className=" text-center p-4 pinkText">What Is Our Goal?</h2>
			<div className="px-4 pb-4">
			...
			<Link to="/contact" className="row justify-content-center text-decoration-none">
				<div className="btn btn-info btn-lg ">Contact Form</div>
			</Link>
		</div>
	);
};
